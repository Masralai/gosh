...
import (
	...
	"github.com/Masralai/gosh/internal/readline/internal/color"
	...
	"github.com/Masralai/gosh/internal/readline/internal/strutil"
...
type Engine struct {
	...
	postDisplay   func(line []rune) string // Zsh-style inline ghost text after cursor
	startCols      int
	startRows      int
	lineCol        int
	lineRows       int
...
// SetPostDisplay sets the callback for inline ghost text (zsh-style autosuggestions).
func (e *Engine) SetPostDisplay(postDisplay func(line []rune) string) {
	e.postDisplay = postDisplay
}
